...
goalkeepers_points = calculate_adjusted_points(goalkeepers_sorted, fixtures_data, 1, 19)
defenders_points = calculate_adjusted_points(defenders_sorted, fixtures_data, 1, 19)
midfielders_points = calculate_adjusted_points(midfielders_sorted, fixtures_data, 1, 19)
forwards_points = calculate_adjusted_points(forwards_sorted, fixtures_data, 1, 19)
